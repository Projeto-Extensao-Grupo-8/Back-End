...
public interface ConsultaRepository extends JpaRepository<Consulta, Integer> {
    ...
    @Query("SELECT c FROM Consulta c WHERE c.fkFuncionario.idFuncionario = :idFuncionario AND DATE(c.data) = :data AND c.status <> 'CANCELADA'")
    List<Consulta> findByFuncionarioAndData(@Param("idFuncionario") Integer idFuncionario, @Param("data") LocalDate data);
